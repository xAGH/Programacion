    ...
    <body>
        ...
        <article>
            ...
            <form action="#" method="POST">
                ...
                <br>
                <input type="text" required name="asignatura" id="nombre" placeholder="Ingrese el nombre de la asignatura">

                <p class='penviar'><input class='enviar' type="submit" name="enviar" value="Agregar Asignatura"></p>
...
<?php
    if(isset($_POST['enviar'])){
        ...
        $insertardatos = "INSERT INTO asignatura (nomasignatura) VALUES('$asig')";
 ...
 <div class="caja" id="caja">        
        <table class="tabla">
            <thead>
                <tr>
                    <th><p>ID</p></th>
                    <th><p>NOMBRE DE LA ASIGNATURA</p></th>
                    <th><p>EDITAR</p></th>
        ...
        <tbody>
                <tr>
                    ...
                    <td><?= $row['nomasignatura'] ?></td>
                    <td class="editartd"><a href="editar/editarasig.php?idasignatura=<?= $row['idasignatura'] ?>">Editar</a></td>
                    <td class="borrartd"><a href="borrar/borrarasig.php?idasignatura=<?= $row['idasignatura'] ?>"><button class="borrar" type='button' onclick="return ConfirmDelete()">X</button></a></td>
                </tr>
        </tbody>
            <?php } ?>
        </table>    
    ...
    <?php
        if(isset($_GET['editar'])){
            include 'editar/editarasig.php';
        }
    ?>
    <?php
        if(isset($_GET['borrar'])){

            include 'borrar/borrarasig.php';
